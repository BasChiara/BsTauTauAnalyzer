...
import glob
# my imports
import BsTauTauAnalyzer.Flattener.EraConfig as eracfg
...
'''.format(
  ...
  with open(workerFile,'w') as worker:
    ...
    worker.write('echo "python2 $CMSSW_BASE/src/PhysicsTools/NanoAODTools/scripts/nano_postproc.py \\\\"\n')
    ...
    worker.write('python2 $CMSSW_BASE/src/PhysicsTools/NanoAODTools/scripts/nano_postproc.py \\\n')
