...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        print('\t [input] %d files in --- %s'%(n_infiles,indataset))
        ...
        print('\t [output] %d files in --- %s'%(n_outfiles, outdataset))
        ...
        if n_outfiles < n_infiles:
            log.print_warning(' Missing files %d (input %d, output %d)'%(n_infiles-n_outfiles, n_infiles, n_outfiles, dataset_name))
        elif n_outfiles > n_infiles:
            log.print_warning(' Too many files %d (input %d, output %d)'%(n_outfiles-n_infiles, n_infiles, n_outfiles, dataset_name))
        elif n_outfiles == n_infiles:
